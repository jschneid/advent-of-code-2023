...
class Hand:
    def __init__(self, cards_string, bid):
        ...
        self.joker_count = cards_string.count('J')
        self.bid = int(bid)
    ...
    def card_character_to_int(self, card_character):
        match card_character:
            ...
            case 'Q':
                return 12
            case 'J':
                # In homage to the Slylandro from Star Control 2.
                # https://wiki.starcontrol.com/index.php?title=Probe
                return -999
            case 'T':
                return 10
            case _:
    ...
    def strength(self):
        ...
        if self.joker_count > 0:
            counter.remove(self.joker_count)
            counter[0] += self.joker_count
